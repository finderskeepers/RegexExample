...
public class Application {
	...
	public boolean isProper(String line) {
		...
		String pattern = "sayilar(([0-9]+\\s)+)([0-9]+#)"; // format is like :
															// sayilar12 24 34#

		Pattern pt = Pattern.compile(pattern); // compiles defined string(your
												// regex) into a pattern
	...
	public String[] parsing(String[] lines) { // splits the proper lines into
												// numbers and
		...
		while (lines[countForLines] != null) { // if line is not null
			...
			if (isProper(lines[countForLines])) { // if line is proper according
													// to you regex design
	...
	public double harmonicalAverage(String[] array) { // makes harmonical
														// average of founded
